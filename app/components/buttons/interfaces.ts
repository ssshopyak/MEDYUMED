...
export interface BigButtonProps extends Omit<TouchableScaleFeedbackProps, 'children'> {
  backgroundColor?: string;
  disabledBackgroundColor?: string;
  textColor?: string;
  disabledTextColor?: string;
...
export interface StockButtonProps extends Omit<TouchableScaleFeedbackProps, 'children'> {
  wrapperStyle?: ViewStyle;
  count: number;
  onPress: () => void;
  load?: boolean;
